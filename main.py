...
try:
    ...
    for i,(conf,address,a,sc,trades) in enumerate(top,1):
        ...
        liq=liquidity_for(address,liquidity); liq_sda=n(liq.get('liquidity_sda_equivalent')); buy50=liq.get('buy_50_sda') or {}; impact=buy50.get('estimated_price_impact_pct'); impact_txt=f"{n(impact):.2f}%" if impact is not None else 'n/a'
        if liq:
    ...
    for _,address,a,sc in candidates[:slots]:
        ...
        liq_sda=n(liq.get('liquidity_sda_equivalent')); buy50=liq.get('buy_50_sda') or {}; impact=buy50.get('estimated_price_impact_pct'); impact_txt=f"{n(impact):.2f}%" if impact is not None else 'n/a'
