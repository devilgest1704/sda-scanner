...
def menu_keyboard():
    return {"inline_keyboard":[[{"text":"🔄 Refresh","callback_data":"REFRESH"}],[{"text":"📐 Technical Analysis","callback_data":"TECH"}],[{"text":"🤖 Paper Trading","callback_data":"PAPER"}],[{"text":"👛 Real Wallet & Positions","callback_data":"REAL"}],[{"text":"📊 Market Momentum","callback_data":"MOMENTUM"}],[{"text":"🐞 Market Debug","callback_data":"DEBUG"}]]}
